...
if (isFullDarkMode) {
  fullDarkModeCheckbox.checked = true //Used Local storage concept for after reload changes will not be lost of checkbox
}
...
function changeTheme(checkbox, element, localStorageKey) {
  if (checkbox.checked) {
    ...
    localStorage.setItem(localStorageKey, true) //Used Local storage concept for after reload changes will not be lost of checkbox
  } else {
...
//Note :- //Used Local storage concept for after reload changes will not be lost of checkbox